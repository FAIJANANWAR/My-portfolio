...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden border-t border-white/[0.06]" style={{ background: "rgba(17,17,20,0.5)" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
          ...
          >
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-8">
              Whether you need a full-stack SaaS application, a secure dashboard interface, smart contract integration, or an end-to-end blockchain system — I&apos;m ready to collaborate. Let&apos;s discuss your project goals.
            </p>

            <div className="flex flex-col gap-5">
              {[
                { Icon: Mail, label: "Email", value: "Faizan244244@gmail.com", href: "mailto:Faizan244244@gmail.com" },
                { Icon: Phone, label: "Phone", value: "+91 70147 02263", href: "tel:7014702263" },
                { Icon: MapPin, label: "Location", value: "India", href: null },
              ].map(({ Icon, label, value, href }) => (
                <div key={label} className="flex items-center gap-4 group/contact-item">
                  <div className="w-10 h-10 rounded-xl bg-[rgba(99,102,241,0.06)] border border-[rgba(99,102,241,0.12)] flex items-center justify-center shrink-0 group-hover/contact-item:scale-105 transition-transform duration-250">
                    <Icon className="w-4 h-4 text-[var(--color-cyber-indigo)]" />
                  </div>
                  <div>
            ...
            <div className="mb-4 min-h-[2.5rem]">
              ...
              {status === "error" && (
                <div className="flex items-center gap-2 px-4 py-3 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl text-sm">
                  <AlertCircle className="w-4 h-4 shrink-0" /> Something went wrong. Please email me directly at Faizan244244@gmail.com
                </div>
              )}
            </div>

            <form ref={formRef} onSubmit={handleSubmit} className="glass rounded-2xl border border-[rgba(99,102,241,0.15)] hover:border-[rgba(99,102,241,0.3)] shadow-[0_0_40px_rgba(99,102,241,0.03)] hover:shadow-[0_0_40px_rgba(99,102,241,0.08)] transition-all duration-500 p-6 sm:p-8 flex flex-col gap-5">
              ...
              <button
                ...
                className="w-full bg-[var(--color-cyber-indigo)] hover:bg-[var(--color-electric-blue-hover)] text-white rounded-xl px-4 py-3.5 text-sm font-bold transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed glow hover:scale-[1.01] active:scale-100 cursor-pointer"
              >
                {isSubmitting ? (
