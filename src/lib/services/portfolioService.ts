...
const initialAbout: AboutData = {
  ...
  timeline: [
    { year: "MAY 2026 – AUG 2026", title: "Full Stack Engineer (Orinson Technologies) - Remote", description: "Collaborated with cross-functional remote teams to build and optimize responsive web applications." },
    { year: "MAY 2026 – AUG 2026", title: "Web Developer (Global IT Providers) - In-Office", description: "Contributed to web development contracts in-office with focus on database design and modular React components." },
  ],
  avatarUrl: "/profile.jpg",
};
...
const initialExperiences: ExperienceItem[] = [
  {
    ...
    isCurrentJob: false,
    location: "Remote",
    description: "Collaborated with a cross-functional team in a remote environment to design, build, and optimize responsive full-stack web applications with modern architectures.",
    techStack: ["React", "TypeScript", "Node.js", "PostgreSQL", "Tailwind CSS"],
    achievements: [
      "Collaborated in remote environments to coordinate team sprints.",
      "Structured clean frontend interfaces and backend database connections.",
      "Optimized application page speeds and codebase modularity.",
    ],
    order: 1,
  },
  {
    ...
    isCurrentJob: false,
    location: "In-Office",
    description: "Contributed to end-to-end web development contracts in an in-office setting with focus on clean codebase architecture, database integration, and high-performance client interfaces.",
    techStack: ["React", "CSS Variables", "PostgreSQL", "MongoDB"],
    achievements: [
      "Assisted in PostgreSQL/MongoDB database design and index optimization.",
      "Designed highly modular client-side components with React and CSS variables.",
      "Ensured seamless application flow and responsiveness under senior review.",
    ],
    order: 2,
  },
];
